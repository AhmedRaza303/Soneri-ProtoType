    ...
    return (
      <MobilePage>
            ...
            <>
              ...
              {po.status !== 'Approved' && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-2 rounded-xl text-[11px] font-bold text-white bg-emerald-600 hover:bg-emerald-500 cursor-pointer"
                >
              ...
              {po.status !== 'Rejected' && (
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-2 rounded-xl text-[11px] font-bold text-rose-700 bg-rose-50 border border-rose-200 hover:bg-rose-100 cursor-pointer"
                >
        ...
        <MobileContent>
                ...
                <div key={idx} className="bg-white rounded-2xl border border-slate-200 p-3.5 shadow-xs">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <p className="text-[11px] font-extrabold text-[#0f2b3c] font-mono">{item.itemCode}</p>
                      <p className="text-[11px] font-semibold text-slate-700 mt-0.5 leading-snug">{item.description}</p>
                    </div>
                    <p className="text-[11px] font-black text-slate-900 font-mono tabular-nums shrink-0">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-3">
                    <div>
                      ...
                      <p className="text-[11px] font-bold text-slate-900 font-mono">{item.quantity.toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Unit</p>
                      <p className="text-[11px] font-semibold text-slate-700">{item.unit}</p>
                    </div>
                    <div>
                      <p className="text-[9px] font-bold uppercase tracking-wider text-slate-400">Unit Price</p>
                      <p className="text-[11px] font-bold text-slate-900 font-mono">{item.unitPrice.toLocaleString()}</p>
                    </div>
                  </div>
                </div>
              ))}
              <div className="rounded-2xl bg-[#0f2b3c] text-white p-3.5 flex items-center justify-between shadow-sm">
                <span className="text-[10px] font-bold uppercase tracking-wider text-white/70">Net Payable Value</span>
                <span className="text-[12px] font-black font-mono tabular-nums">{po.currency} {po.netAmount.toLocaleString()}</span>
              </div>
            </div>
          </SoftCard>
          ...
          <SoftCard>
            <h3 className="text-sm font-bold text-slate-800 mb-4">Multi-Stage Approval Hierarchy</h3>
            ...
            <div className="p-4 sm:px-6 sm:py-3 space-y-2">
              {prof.items.map((item, idx) => (
                <div key={idx} className="bg-white rounded-2xl border border-slate-200 p-3.5 shadow-xs">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      <p className="text-[11px] font-extrabold text-[#0f2b3c] leading-snug">{item.description}</p>
                      <p className="text-[11px] font-semibold text-slate-600 mt-0.5 font-mono">
                        HS {item.hsCode}
                      </p>
                    </div>
                    <p className="text-[11px] font-black text-slate-900 font-mono tabular-nums shrink-0">
                      {prof.currency} {item.amount.toLocaleString()}
                    </p>
                  </div>
                  <div className="grid grid-cols-3 gap-2 mt-3">
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-bold text-slate-900 font-mono">{item.rate.toFixed(2)}</p>
                    </div>
                  </div>
                </div>
              ))}
              <div className="rounded-2xl bg-[#0f2b3c] text-white p-3.5 flex items-center justify-between shadow-sm">
                <span className="text-[10px] font-bold uppercase tracking-wider text-white/70">Total Invoice Value</span>
                <span className="text-[12px] font-black font-mono tabular-nums">{prof.currency} {prof.amount.toLocaleString()}</span>
              </div>
            </div>
          </SoftCard>
        </MobileContent>
